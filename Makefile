# This Makefile is for the strict::ModuleName extension to perl.
#
...
#	NAME => q[strict::ModuleName]
#	VERSION_FROM => q[ModuleName.pm]
#	dist => { COMPRESS=>q[gzip -6f], SUFFIX=>q[gz] }
...
DISTNAME = strict-ModuleName
NAME_SYM = strict_ModuleName
VERSION = 0.03
VERSION_SYM = 0_03
XS_VERSION = 0.03
INST_BIN = blib/bin
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/strict
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/strict
...
TO_INST_PM = ModuleName.pm

PM_TO_BLIB = ModuleName.pm \
	$(INST_LIBDIR)/ModuleName.pm
...
manifypods : pure_all ModuleName.pm
	@$(POD2MAN) \
	ModuleName.pm \
	$(INST_MAN3DIR)/strict::ModuleName.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/ModuleName.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"strict-ModuleName\" VERSION=\"0,03,0,0\">\n}. qq{\t<TITLE>strict-ModuleName</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"aix\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > strict-ModuleName.ppd
